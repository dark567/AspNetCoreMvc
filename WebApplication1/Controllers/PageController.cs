...
namespace WebApplication1.Controllers
{
    public class PageController : Controller
    {
        ...
        public IActionResult Index(int pageId, PageType pageType)
        {
            ...
            switch (pageType)
            {
                case PageType.Directory: _viewModel = _servicesmanager.Directorys.DirectoryDBViewModelById(pageId); break;
        ...
        public IActionResult PageEditor(int pageId, PageType pageType, int directoryId = 0)
        {
            ...
            switch (pageType)
            {
                ...
                case PageType.Material:
                    if (pageId != 0) _editModel = _servicesmanager.Materials.GetMaterialEditModel(pageId);
